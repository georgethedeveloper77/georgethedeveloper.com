...
const seo = {
  ...
  og: {
    title: "georgethedeveloper Portfolio",
    type: "website",
    url: "http://georgethedeveloper.tech/",
  },
};

//Home Page
const greeting = {
  title: "georgethedeveloper",
  logo_name: "georgethedeveloper",
  nickname: "George_Karani",
  subTitle:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.",
  resumeLink:
  ...
  degrees: [
    {
      ...
      descriptions: [
        ...
        "⚡ Apart from this, I have done courses on Networking Deep Learning, Data Science, Cloud Computing and Full Stack Development.",
        "⚡ I was selected for Merit cum Means Scholarship which is given to top 10% of students in college. I have received award from respected director for consistently best performance in academics.",
      ],
      website_link: "http://jkuat.co.ke",
    },
  ],
};
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects makes use of vast variety of latest technology tools. My best experience is to create Data Science projects and deploy them to web applications using cloud infrastructure. I have more than 50 Projects written in JavaScript, flutter and Python which are deployed on github.",
...
const contactPageData = {
  ...
  addressSection: {
    ...
    location_map_link: "https://goo.gl/maps/m1rqMNmHR4eXCV6z9",
  },
  phoneSection: {
    title: "Phone Number",
    subtitle: "Use Messenger",
  },
};
